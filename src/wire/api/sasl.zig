...
test "encode authenticate request: fake SCRAM client-first message" {
    ...
    const expected = [_]u8{
        ...
        0x6e, 0x2c, 0x2c, 0x6e, 0x3d, 0x75, 0x73, 0x65, 0x72, 0x2c, 0x72, 0x3d, 0x61, 0x62, 0x63, 0x31, 0x32, 0x33, // "n,,n=user,r=abc123"
    };
...
test "decode authenticate response: success with server-first and session_lifetime" {
    ...
    const fixture = [_]u8{
        ...
        0x72, 0x3d, 0x61, 0x62, 0x63, 0x31, 0x32, 0x33, 0x2c, 0x73, 0x3d, 0x2e, 0x2e, 0x2e, 0x2c, 0x69, 0x3d, 0x34, 0x30, 0x39, 0x36, // "r=abc123,s=...,i=4096"
